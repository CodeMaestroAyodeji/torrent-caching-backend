...
const { uploadFileToB2 } = require('../utils/b2Upload');
...
const startTorrentDownload = async (magnetLink, userId) => {
    try {
        ...
        return new Promise((resolve, reject) => {
            ...
            client.add(magnetLink, { path: undefined }, async (torrent) => {
                try {
                    ...
                    torrent.on('done', async () => {
                        ...
                        try {
                            ...
                            for (const file of torrent.files) {
                                ...
                                await uploadFileToB2(stream, file.name);
                            }
                            ...
                            await Torrent.findByIdAndUpdate(newTorrent._id, { 
                                status: 'error',
                                error: 'Failed to upload to B2: ' + error.message 
                            });
                        }
